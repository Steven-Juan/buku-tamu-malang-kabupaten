    ...
    <x-container size="lg" class="pb-24 w-full">
        <div class='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full'>
            ...
            <a href="{{ route('department.detail', $pd->slug) }}" wire:navigate
                class='group block bg-white dark:bg-gray-800/50 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 border border-accent dark:border-gray-700 rounded-3xl p-6 min-h-[220px]'>

                <div class="flex flex-col h-full justify-between">
                    <div>
                        <div class='flex items-center justify-between mb-4'>
                            <div class="bg-primary/10 p-3 rounded-2xl group-hover:bg-primary transition-colors">
                    ...
                    <div class="mt-6 flex justify-end">
                        <div
                            class="w-8 h-8 rounded-full bg-accent/30 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors text-text-dark">
