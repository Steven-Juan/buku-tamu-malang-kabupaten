        ...
        <form wire:submit.prevent="submit" class="space-y-8">
            ...
            <div class="space-y-6 animate-fade-in-up">
                ...
                <div>
                    ...
                    <input wire:model="keperluan" list="keperluanList" type="text" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600
               rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#0100CC]"
                    ...
                    <datalist id="keperluanList">
                        ...
                        <option value="Pengurusan perizinan">
                        <option value="Pengambilan dokumen">
                        <option value="Penyerahan berkas">
                        <option value="Klarifikasi data">
                        <option value="Verifikasi dokumen">
                        <option value="Koordinasi kegiatan">
                        <option value="Permintaan informasi">
                        <option value="Pengaduan masyarakat">
                        <option value="Permohonan tanda tangan">
                        <option value="Legalisasi dokumen">
                        <option value="Pengambilan hasil layanan">
                        ...
                        <option value="Monitoring dan evaluasi">
                        <option value="Pendampingan kegiatan">
                        <option value="Supervisi">
                        <option value="Koordinasi antar instansi">
                        <option value="Undangan kegiatan">
                        <option value="Kunjungan kerja pimpinan">

                            <!-- Personal / Umum -->
                        <option value="Keperluan pribadi">
                        <option value="Bertemu pegawai">
                        <option value="Magang / PKL">
                        <option value="Penelitian / skripsi">
                        <option value="Kunjungan edukasi">
                        <option value="Kunjungan umum">
                        <option value="Observasi lapangan">
                        <option value="Wawancara">
                        <option value="Studi lapangan">

                            <!-- Teknis -->
                        <option value="Pengajuan bantuan">
                        <option value="Permintaan data">
                        <option value="Konsultasi teknis">
                        <option value="Pelaporan kegiatan">
                        <option value="Tindak lanjut program">
                        <option value="Sinkronisasi data">
                        <option value="Validasi data">
                        <option value="Input / update data">
                        <option value="Pengambilan data">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-3">
                        @foreach (['Pelayanan sangat memuaskan', 'Proses cepat dan membantu', 'Pelayanan baik dan
                        ramah', 'Cukup baik', 'Perlu peningkatan', 'Pelayanan kurang memuaskan'] as $item)
                        <button type="button" wire:click="$set('pesan_kesan', '{{ $item }}')" class="text-xs px-3 py-1.5 rounded-full border
                    ...
                    <!-- Manual input -->
                    <textarea wire:model="pesan_kesan" rows="2" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600
               rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#0100CC]"
            ...
            <div class="space-y-8 animate-fade-in-up">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        @foreach ([['file' => 'scholar-man.png'], ['file' => 'scholar-woman.png'], ['file' =>
                        'officer-man.png'], ['file' => 'officer-woman.png'], ['file' => 'guest-man.png'], ['file' =>
                        'guest-woman.png']] as $avatar)
            ...
            {{ $selectedAvatar == $avatar['file'] ? 'border-[#0100CC] bg-blue-50 dark:bg-blue-900/20' : 'border-transparent bg-gray-50 dark:bg-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600' }}">
                            ...
                            <div
                                ...
                                <img src="{{ asset('images/avatars/' . $avatar['file']) }}" alt="Avatar"
