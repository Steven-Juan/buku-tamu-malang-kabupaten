        ...
        <form wire:submit.prevent="submit" class="space-y-8">
            ...
            <div class="space-y-6 animate-fade-in-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">Jenis
                            Kelamin</label>
                        <div class="grid grid-cols-2 gap-4">
                            {{-- Laki-laki --}}
                            <div wire:click="$set('jenis_kelamin', 'Laki-laki')"
                                class="cursor-pointer p-4 rounded-2xl border-2 transition-all flex items-center gap-3
             {{ $jenis_kelamin === 'Laki-laki' ? 'border-[#0100CC] bg-blue-50 dark:bg-blue-900/20' : 'border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800' }}">
                                <span class="text-2xl">👨</span>
                                <span
                                    class="font-semibold text-sm {{ $jenis_kelamin === 'Laki-laki' ? 'text-[#0100CC]' : 'text-gray-500' }}">Laki-laki</span>
                            </div>

                            {{-- Perempuan --}}
                            <div wire:click="$set('jenis_kelamin', 'Perempuan')"
                                class="cursor-pointer p-4 rounded-2xl border-2 transition-all flex items-center gap-3
             {{ $jenis_kelamin === 'Perempuan' ? 'border-[#0100CC] bg-blue-50 dark:bg-blue-900/20' : 'border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800' }}">
                                <span class="text-2xl">👩</span>
                                <span
                                    class="font-semibold text-sm {{ $jenis_kelamin === 'Perempuan' ? 'text-[#0100CC]' : 'text-gray-500' }}">Perempuan</span>
                            </div>
                        </div>
                        @error('jenis_kelamin') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
