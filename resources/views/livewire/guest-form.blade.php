        ...
        <form wire:submit.prevent="submit" class="space-y-8">
            ...
            <div class="space-y-8 animate-fade-in-up">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        ['file' => 'man-old.png', 'emoji' => '👨‍🎓'],
                        ['file' => 'woman-old.png', 'emoji' => '👩‍🎓'],
               ...
               {{ $selectedAvatar == $avatar['file'] ? 'border-[#0100CC] bg-blue-50 dark:bg-blue-900/20' : 'border-transparent bg-gray-50 dark:bg-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600' }}">
                            <div
                                class="aspect-square bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl flex items-center justify-center text-4xl">
                                {{ $avatar['emoji'] }}
                            </div>
                        </div>
                        @endforeach
                    </div>
                    @error('selectedAvatar') <span class="text-red-500 text-xs mt-2 block">{{ $message }}</span>
                    @enderror
                    @endif
                ...
                <div class="pt-6 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div wire:ignore x-data="signaturePad(@entangle('ttd_digital'))"
                        x-on:clear-signature.window="clear()">
                        <div
            ...
            <div class="space-y-6 animate-fade-in-up">
                ...
                <div
                    ...
                    <div class="absolute top-0 right-0 p-4 opacity-10">
                        <svg width="80" height="80" viewBox="0 0 24 24" fill="currentColor" class="text-blue-600">
                            <path
                    ...
                    <div class="flex flex-col md:flex-row gap-8 items-start relative z-10">
                        ...
                        <div class="shrink-0 text-center">
                            ...
                            <div
                                class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-blue-300 flex items-center justify-center text-5xl border-4 border-white shadow-lg">
                                @php
                                $emoji = match($selectedAvatar) {
                                'man-young.png' => '👨',
                                'woman-young.png' => '👩',
                                'man-old.png' => '👴',
                                'woman-old.png' => '👵',
                        ...
                        <div class="space-y-3 flex-1">
                            <div>
                                <p class="text-xs text-gray-400 dark:text-gray-500 uppercase font-bold">Nama Lengkap
                                </p>
                                <p class="font-bold text-lg">{{ $nama }}</p>
                            </div>
                            <div class="grid grid-cols-2 gap-4 border-t border-blue-200 dark:border-blue-800 pt-3">
                                <div>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 uppercase font-bold">Instansi
                                        Tujuan</p>
                        ...
                        <div class="shrink-0 text-center">
                            ...
                            @if($ttd_digital)
                            <img src="{{ $ttd_digital }}"
                                class="h-20 w-32 border-2 border-white shadow-md rounded-xl bg-white dark:bg-gray-900 object-contain p-1">
                            @else
                            <div
                ...
                {{-- CAPTCHA --}}
                <div
                    class="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-3xl border border-gray-200 dark:border-gray-700 text-center">
                    <label class="block mb-4 font-bold text-gray-700 dark:text-gray-300">
                        🔐 Keamanan: Berapakah hasil dari
                        <span class="text-2xl text-[#0100CC] mx-2">{{ $captcha_val1 }} + {{ $captcha_val2 }}</span>
                        ?
                    </label>
                    <input wire:model="captcha_answer" type="number"
                        class="w-32 text-center mx-auto border-2 border-gray-300 dark:border-gray-600 rounded-xl p-3 text-lg font-bold bg-white dark:bg-gray-800 focus:ring-2 focus:ring-[#0100CC] outline-none"
                        placeholder="?">
            ...
            <div class="flex justify-between pt-6 border-t border-gray-100 dark:border-gray-700">
                ...
                <button type="button" wire:click="previousStep"
                    class="group inline-flex items-center gap-2 px-6 md:px-8 py-3 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-bold rounded-xl transition-all">
                ...
                @if($currentStep < 3) <button type="button" wire:click="nextStep"
                    class="group inline-flex items-center gap-2 px-6 md:px-10 py-3 bg-gradient-to-r from-[#0100CC] to-[#18D1FF] text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl transition-all active:scale-95">
                    Lanjutkan Formulir
                    <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                        class="group inline-flex items-center gap-2 px-6 md:px-10 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl shadow-lg shadow-green-500/30 hover:shadow-xl transition-all active:scale-95">
                        ...
                        <span wire:loading.remove wire:target="submit">Kirim & Simpan Data</span>
