...
$wire.on('tamu-berhasil-disimpan', (event) => {
    Swal.fire({
        ...
        text: 'Terima kasih, data kunjungan Anda telah tersimpan. Mohon kesediaan Anda untuk mengisi survei kepuasan kami.',
        icon: 'success',

        // Tombol Utama (Selesai/Kembali)
        showConfirmButton: true,
        confirmButtonText: 'Selesai',
        confirmButtonColor: '#0100CC',

        // Tombol Survei Indeks Kepuasan Masyarakat
        showDenyButton: true,
        denyButtonText: 'Isi Survei Indeks Kepuasan Kepuasan Masyarakat',
        denyButtonColor: '#10b981',

        allowOutsideClick: false,
    }).then((result) => {
        if (result.isDenied) {
            window.open('https://forms.gle/rEdzVztFAXKsvAfJA', '_blank'); // Ganti '#' dengan link GForm
