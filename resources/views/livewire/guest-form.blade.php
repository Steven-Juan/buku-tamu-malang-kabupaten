        ...
        <form wire:submit.prevent="submit" class="space-y-8">
            ...
            <div class="space-y-6 animate-fade-in-up">
                ...
                <div>
                    ...
                    <input wire:model.live="keperluan" list="keperluanList" type="text"
                        class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#0100CC] transition-all"
                        placeholder="Ketik atau pilih keperluan..." autocomplete="off">
                    ...
                    <datalist id="keperluanList">
                        ...
                        <option value="Verifikasi Tanda Tangan Elektronik">
